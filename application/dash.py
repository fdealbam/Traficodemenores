...
TOTTRAFMENORES = delitoso['Grand total'].sum()
pobtot = junto15_21['Totpob1521'].sum()
TASATRAFMENORES = round((TOTTRAFMENORES/pobtot)*100000,0)
...
bulletedo3 = ("Los 10 municipios con más tráfico de menores fueron: "+str(n1edo3) +" ("+ str(v1edo3)+"), "+str(n2edo3) +" ("+ str(v2edo3)+"), "+str(n3edo3) +" ("+ str(v3edo3)+"), "+str(n4edo3) +" ("+ str(v4edo3)+"), "+str(n5edo3) +" ("+ str(v5edo3)+"), "+str(n6edo3) +" ("+ str(v6edo3)+") y "+str(n7edo3) +" ("+ str(v7edo3)+"). ")#+str(n8edo3) +" ("+ str(v8edo3)+"), "+str(n9edo3) +" ("+ str(v9edo3)+") y "+str(n10edo3) +" ("+ str(v10edo3)+").")
bulletedo4 = ("Los 10 municipios con más tráfico de menores fueron: "+str(n1edo4) +" ("+ str(v1edo4)+"), "+str(n2edo4) +" ("+ str(v2edo4)+"), "+str(n3edo4) +" ("+ str(v3edo4)+"), "+str(n4edo4) +" ("+ str(v4edo4)+"), "+str(n5edo4) +" ("+ str(v5edo4)+"), "+str(n6edo4) +" ("+ str(v6edo4)+"), "+str(n7edo4) +" ("+ str(v7edo4)+"), "+str(n8edo4) +" ("+ str(v8edo4)+"), "+str(n9edo4) +" ("+ str(v9edo4)+") y "+str(n10edo4) +" ("+ str(v10edo4)+").")
       ...
       dbc.Row(
            [
                ...
                html.P(
                   ...
                   " Entre 2015 y 2022 se registraron "+ str(f"{int(TOTTRAFMENORES):,}") +" casos, lo que representa una tasa de "+
       str(TASATRAFMENORES) +" delitos por cada 100 mil habitantes. "+
                    "Este tablero analítico se compone de una sección en la cual tratamos el tráfico de menores, observamos "
     ...
     dbc.Row(
           [
               ...
               dbc.Col(dbc.Button(([html.H5("2022", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Traficodemenores/blob/main/application/static/Mapa%20traficodemenores%20Total2022.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
